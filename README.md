...
- :warning: Bezier calculation function was generated by GitHub Copilot. While already checked ([#1](https://github.com/ffunatsu/ofxAEEasingLoader/pull/1)), but please use with care.
...
[Simple p5.js json file editor](https://ffunatsu.github.io/ofxAEEasingLoader/editor/) (works on web browser): source: [`./docs/editor`](./docs/editor/).
